...
public class LogicManagerTest {
    ...
    public void execute_commandExecutionError_throwsCommandException() {
        String deleteCommand = DeleteStudentCommand.COMMAND_WORD + " a1234567a";

        String expectedMessage = String.format(DeleteStudentCommand.MESSAGE_STUDENT_NOT_FOUND, "a1234567a");
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        String addStudentCommand = AddStudentCommand.COMMAND_WORD + NAME_DESC_AMY + STUDENT_ID_DESC_AMY
