...
public class AddStudentCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser,
                PREAMBLE_WHITESPACE + NAME_DESC_BOB + STUDENT_ID_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB,
    ...
    public void parse_invalidValue_failure() {
        ...
        // invalid student id
        assertParseFailure(parser,
                NAME_DESC_BOB + INVALID_STUDENT_ID_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB,
        ...
        // two invalid values, only first invalid value reported (Name evaluated first)
        assertParseFailure(parser,
