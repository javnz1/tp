...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser,
                PREAMBLE_WHITESPACE + NAME_DESC_BOB + STUDENT_ID_DESC_BOB
        ...
        assertParseSuccess(parser,
                NAME_DESC_BOB + STUDENT_ID_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
    ...
    public void parse_repeatedNonTagValue_failure() {
        String validExpectedPersonString = NAME_DESC_BOB + STUDENT_ID_DESC_BOB + PHONE_DESC_BOB
        ...
        assertParseFailure(parser,
                validExpectedPersonString + STUDENT_ID_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY
                        + NAME_DESC_AMY + validExpectedPersonString,
                Messages.getErrorMessageForDuplicatePrefixes(
                        PREFIX_NAME, PREFIX_STUDENT_ID, PREFIX_EMAIL, PREFIX_PHONE));
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser,
                NAME_DESC_AMY + STUDENT_ID_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY,
                new AddCommand(expectedPerson));
    }
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        // missing name prefix
        assertParseFailure(parser,
                VALID_NAME_BOB + STUDENT_ID_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB,
                expectedMessage);

        // missing student id prefix
        assertParseFailure(parser,
                NAME_DESC_BOB + VALID_STUDENT_ID_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB,
                expectedMessage);

        // missing phone prefix
        assertParseFailure(parser,
                NAME_DESC_BOB + STUDENT_ID_DESC_BOB + VALID_PHONE_BOB + EMAIL_DESC_BOB,
                expectedMessage);

        // missing email prefix
        assertParseFailure(parser,
                NAME_DESC_BOB + STUDENT_ID_DESC_BOB + PHONE_DESC_BOB + VALID_EMAIL_BOB,
                expectedMessage);

        // all prefixes missing
        assertParseFailure(parser,
                VALID_NAME_BOB + VALID_STUDENT_ID_BOB + VALID_PHONE_BOB + VALID_EMAIL_BOB,
                expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        // invalid phone
        assertParseFailure(parser,
                NAME_DESC_BOB + STUDENT_ID_DESC_BOB + INVALID_PHONE_DESC + EMAIL_DESC_BOB
                        + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
                Phone.MESSAGE_CONSTRAINTS);

        // invalid email
        assertParseFailure(parser,
                NAME_DESC_BOB + STUDENT_ID_DESC_BOB + PHONE_DESC_BOB + INVALID_EMAIL_DESC
                        + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
        ...
        assertParseFailure(parser,
                INVALID_NAME_DESC + STUDENT_ID_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB,
                Name.MESSAGE_CONSTRAINTS);
